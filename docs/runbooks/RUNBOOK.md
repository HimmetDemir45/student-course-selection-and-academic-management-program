...
Bu dosya üretim ve ders ortamı için **tek sayfalık** özet sağlar. Ayrıntılar: `deployment-runbook.md`, `rollback-runbook.md`, `incident-response.md`, `../PHASE9_RUNBOOK.md`, `../../RELEASE.md`.
...
Yükseltme: `incident-response.md`, `SECURITY.md` (secret sızıntısı).
